...
export {default as FormInput} from '../components/form-input/demo'export {default as FormSelect} from '../components/form-select/demo'export {default as FormDate} from '../components/form-date/demo'export {default as FormCity} from '../components/form-city/demo'export {default as FormItem} from '../components/form-item/demo'/* @init<%export {default as ${componentNameUpper}} from '../components/${componentName}/demo'%> */
